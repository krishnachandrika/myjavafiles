...
class EmployeeClass {
		...
		public EmployeeClass(String name, String surName, String address, double basicSalary) {
			super();
			this.name = name;
		...
		public static void main(String[] args) {
			...
			//Object 1 Details
			System.out.println("Name of the Temporary Emp:"+te.getName());
			System.out.println("Surname of the temporary Emp:"+te.getSurName());
			System.out.println("Addree of the Temporary Emp:"+te.getAddress());
			System.out.println("Basic salary of TemporaryEmp:"+te.getBasicSalary());
			System.out.println("Number of days worked in a month is :"+te.getNo_of_days_worked());
			System.out.println("Net Salary of the Temporary Employee in a month is :"+te.netSalary());
			
			
			
			
			//object2
			System.out.println("Name of the Temporary Emp:"+te1.getName());
			System.out.println(" Surname of the temporary Employee is:"+te1.getSurName());
			System.out.println(" Addree of the Temporary Employee is:"+te1.getAddress());
			System.out.println("Basic salary of TemporaryEmployee is:"+te1.getBasicSalary());
			System.out.println("Number of days worked in a month is :"+te1.getNo_of_days_worked());
			System.out.println("Net Salary of the Temporary Employee in a month is :"+te1.netSalary());
			
			
			//object3
			System.out.println("Name of the Temporary Emp:"+te2.getName());
	...
	class TemporaryEmployee extends EmployeeClass{
